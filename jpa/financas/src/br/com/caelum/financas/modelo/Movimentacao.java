...
public class Movimentacao {
	...
	//Tipo Enum usamos a anotação @Enumerated para dizer para o JPA tratar esse campo como Enum
	@Enumerated(EnumType.STRING)
	private TipoMovimentacao tipo;
	
	//Usamos a anotação @Temporal(TemporalType.TIMESTAMP) para dizer que queremos gravar a data e a hora
	...
	//Essa é a parte forte do relacionamento
	@ManyToOne
	private Conta conta;
