    ...
    extends Service
{
     ...
     *     returns EstoqueWS
     */
    @WebEndpoint(name = "EstoqueWSImpPort")
    public EstoqueWS getEstoqueWSImpPort() {
        return super.getPort(new QName("http://ws.estoque.caelum.com.br/", "EstoqueWSImpPort"), EstoqueWS.class);
    }
     ...
     */
    @WebEndpoint(name = "EstoqueWSImpPort")
    public EstoqueWS getEstoqueWSImpPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.estoque.caelum.com.br/", "EstoqueWSImpPort"), EstoqueWS.class, features);
    }
